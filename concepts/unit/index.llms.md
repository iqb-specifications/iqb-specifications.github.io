...
|----|----|----|
|  | [Index](../../concepts/unit/unit-index.llms.md): Diese Datei ist mindestens erforderlich und referenziert die anderen Datenblöcke. | \*.ix.json |
| `userInterface` | [User-Interface](../../concepts/unit/userInterface.llms.md): Daten für die Darstellung und ggf. Interaktion durch die Testperson. | \*.ui.json |
